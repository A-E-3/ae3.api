...
public final class Flow extends AbstractSAPI {
	...
	/**
	 * Creates a message object containing a buffer passed. This message should
	 * return true on isBinary() method and same buffer as a getBinary() method
	 * result.
	 *
	 * @param owner
	 * @param title
	...
	/**
	 * Creates a message object containing a copier passed. This message should
	 * return true on isBinary() method and same buffer as a getBinary() method
	 * result.
	 *
	 * @param owner
	...
	/**
	 * Creates a message object containing a copier and text passed. This
	 * message should return true on isBinary() and isCharacter() method and
	 * same buffer as a getBinary() method result and same text as getText()
	 * method result.
	 *
	 * @param owner
	 * @param title
	 ...
	 * @return message
	 */
	public static final UniversalMessage<?> binaryAndCharacter(final String owner,
			final String title,
	...
	public static UniversalMessage<?> binaryWrapCharacter(final CharacterMessage<?> characterMessage) {
		...
		/**
		 * can't really use it since implementors could use this method to
		 * implement toBinary method,... <code>
		 ...
		 * </code> ...we will enforce that they checked and handled it
		...
		}
		{
			...
			if (contentCharset.length() > 0) {
				...
				final TransferCopier binary = Transfer.createCopier(text, charset);
				attributes.baseDefine("Content-Type", (contentTypeAttribute != null
	...
	/**
	 * Creates a message object containing a string passed. This message should
	 * return true on isCharacter() methods and same string as a getText()
	 * method result.
	 *
	 * @param owner
	 * @param title
	...
	/**
	 * Creates an empty message object. This message should return true on
	 * isEmpty() method.
	 *
	 * @param owner
	 * @param title
	...
	/**
	 * Creates a message object containing a file passed. This message should
	 * return true on isFile() method and same file as a getFile() method
	 * result.
	 *
	 * @param owner
	 * @param title
	...
	public static final CharacterMessage<?> mimeAttribute(final String owner, final String title, final String attributeValue) {
		...
		for (; attrsTokenizer.hasMoreTokens();) {
			...
			if (positionEquals == -1) {
				...
				attributes.baseDefine(tk.substring(0, positionEquals).trim(), length > 1 && value.charAt(0) == '"' && value.charAt(length - 1) == '"'
	...
	/**
	 * Creates a message object containing an object passed. This message should
	 * return true on isObject() method and same object on getObject() method
	 * invocation.
	 *
	 * @param owner
	 * @param title
	...
	/**
	 * Creates a message object containing a sequence of messages. This message
	 * should return true on isSequence() method and an array of messages as a
	 * getSequence() method result.
	 *
	 * @param owner
	 * @param title
	 * @param sequence
