 ...
 *
 *         6) Strings, EMPTY, 1-54 for ASCII, 1-48 chars length for 8bit, 1-24 chars length for
 *         UNICODE (Read/Write)
 *
 *         7) Bytes, 0-48 bytes
 *
...
enum GuidType {
	...
	NUMBER_NEGATIVE_INT_64BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return ((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32) + ((long) (bytes[5] & 255) << 24)
					+ ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0);
		}
	...
	NUMBER_NEGATIVE_INT_56BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return 0xFF00000000000000L + ((long) (bytes[1] & 255) << 48) + ((long) (bytes[2] & 255) << 40) + ((long) (bytes[3] & 255) << 32) + ((long) (bytes[4] & 255) << 24)
					+ ((bytes[5] & 255) << 16) + ((bytes[6] & 255) << 8) + ((bytes[7] & 255) << 0);
		}
	...
	NUMBER_NEGATIVE_INT_48BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return 0xFFFF000000000000L + ((long) (bytes[1] & 255) << 40) + ((long) (bytes[2] & 255) << 32) + ((long) (bytes[3] & 255) << 24) + ((bytes[4] & 255) << 16)
					+ ((bytes[5] & 255) << 8) + ((bytes[6] & 255) << 0);
		}
	...
	NUMBER_NEGATIVE_INT_40BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return 0xFFFFFF0000000000L + ((long) (bytes[1] & 255) << 32) + ((long) (bytes[2] & 255) << 24) + ((bytes[3] & 255) << 16) + ((bytes[4] & 255) << 8)
					+ ((bytes[5] & 255) << 0);
		}
	...
	NUMBER_NEGATIVE_INT_32BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return 0xFFFFFFFF00000000L + ((long) (bytes[1] & 255) << 24) + ((bytes[2] & 255) << 16) + ((bytes[3] & 255) << 8) + ((bytes[4] & 255) << 0);
		}
	...
	NUMBER_POSITIVE_INT_16BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP16BIT + ((bytes[1] & 255) << 8) + ((bytes[2] & 255) << 0) + 0x10000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_24BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP24BIT + ((bytes[1] & 255) << 16) + ((bytes[2] & 255) << 8) + ((bytes[3] & 255) << 0) + 0x1000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_32BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP32BIT + ((long) (bytes[1] & 255) << 24) + ((bytes[2] & 255) << 16) + ((bytes[3] & 255) << 8) + ((bytes[4] & 255) << 0)
					+ 0x100000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_40BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP40BIT + ((long) (bytes[1] & 255) << 32) + ((long) (bytes[2] & 255) << 24) + ((bytes[3] & 255) << 16) + ((bytes[4] & 255) << 8)
					+ ((bytes[5] & 255) << 0) + 0x10000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_48BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP48BIT + ((long) (bytes[1] & 255) << 40) + ((long) (bytes[2] & 255) << 32) + ((long) (bytes[3] & 255) << 24) + ((bytes[4] & 255) << 16)
					+ ((bytes[5] & 255) << 8) + ((bytes[6] & 255) << 0) + 0x1000000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_56BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP56BIT + ((long) (bytes[1] & 255) << 48) + ((long) (bytes[2] & 255) << 40) + ((long) (bytes[3] & 255) << 32) + ((long) (bytes[4] & 255) << 24)
					+ ((bytes[5] & 255) << 16) + ((bytes[6] & 255) << 8) + ((bytes[7] & 255) << 0) + 0x100000000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	NUMBER_POSITIVE_INT_64BIT {
		...
		final long getJavaPrimitiveNumberInteger(final byte[] bytes) {
			...
			return GuidType.startINP64BIT + ((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32)
					+ ((long) (bytes[5] & 255) << 24) + ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0);
		}
	...
	NUMBER_NEGATIVE_NOT_INTEGER {
		...
		final BasePrimitiveNumber getBaseObject(final byte[] bytes) {
			...
			return Base.forDouble(this.getJavaPrimitiveNumberDouble(bytes));
		}
		...
		final double getJavaPrimitiveNumberDouble(final byte[] bytes) {

			return Double.longBitsToDouble(
					0xFFFFFFFFFFFFFFFFL ^ ((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32)
							+ ((long) (bytes[5] & 255) << 24) + ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0));
		}
	...
	NUMBER_POSITIVE_NOT_INTEGER {
		...
		final double getJavaPrimitiveNumberDouble(final byte[] bytes) {
			...
			return Double.longBitsToDouble(
					((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32) + ((long) (bytes[5] & 255) << 24)
							+ ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0));
		}
	...
	DATE_NEGATIVE_INT_64BIT {
		...
		@Override
		final BaseDate getBaseObject(final byte[] bytes) {

			return Base.forDateMillis(
					((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32) + ((long) (bytes[5] & 255) << 24)
							+ ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0));
		}
		...
		final Date getJavaObject(final byte[] bytes) {
			...
			return this.getBaseObject(bytes);
		}
	...
	DATE_ZERO {
		...
		private final BaseDate ZERO_DATE = Base.forDateMillis(0L);
		...
		@Override
		final BaseDate getJavaObject(final byte[] bytes) {
	...
	DATE_POSITIVE_INT_40BIT { // till Nov 2004, Sep 2039, Jul 2074
		...
		final BaseDate getBaseObject(final byte[] bytes) {
			...
			final long value = GuidType.startDATE40BIT + ((long) (bytes[1] & 255) << 32) + ((long) (bytes[2] & 255) << 24) + ((bytes[3] & 255) << 16) + ((bytes[4] & 255) << 8)
					+ ((bytes[5] & 255) << 0) + 0x10000000000L * ((bytes[0] & 0xFF) - this.startIndex);
	...
	DATE_POSITIVE_INT_64BIT {
		...
		final BaseDate getBaseObject(final byte[] bytes) {
			...
			final long value = GuidType.startDATE64BIT + ((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40)
					+ ((long) (bytes[4] & 255) << 32) + ((long) (bytes[5] & 255) << 24) + ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0);
			return Base.forDateMillis(value);
		}
	...
	STRING_EMPTY {
		...
		final String getJavaObject(final byte[] bytes) {
			...
			return BaseString.EMPTY.baseValue();
		}
	 ...
	 *
	 * Format: guid-type byte, then 48 bytes of ASCII string encoded in 7 bit for each character. */
	STRING_ASCII54 {
	 ...
	 *
	 * Format: guid-type byte, then length of string in first byte, length of string equals to
	 * length of data */
	STRING_8BIT {
	 ...
	 *
	 * Format: guid-type byte, then length of string in first byte, length of data */
	STRING_UTF8 {
	...
	/** Contains value of an empty binary string */
	BYTES_EMPTY {

		@Override
		final BaseObject getBaseObject(final byte[] bytes) {
	...
	BYTES {
		...
		final BaseObject getBaseObject(final byte[] bytes) {
			...
			return Transfer.wrapCopier(bytes, 2, bytes[1] & 0xFF);
		}
	...
	BYTES48 {
		...
		final BaseObject getBaseObject(final byte[] bytes) {
			...
			return Transfer.wrapCopier(bytes, 1, 48);
		}
	...
	/** For all immutable data binary with length stored as 1 byte, whirlpool-based.
	 *
	...
	/** For all immutable data binary with length stored as 2 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_16BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC16BIT + ((bytes[1] & 255) << 8) + ((bytes[2] & 255) << 0) + 0x10000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 3 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_24BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC24BIT + ((bytes[1] & 255) << 16) + ((bytes[2] & 255) << 8) + ((bytes[3] & 255) << 0) + 0x1000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 4 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_32BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC32BIT + ((long) (bytes[1] & 255) << 24) + ((bytes[2] & 255) << 16) + ((bytes[3] & 255) << 8) + ((bytes[4] & 255) << 0)
					+ 0x100000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 5 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_40BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC40BIT + ((long) (bytes[1] & 255) << 32) + ((long) (bytes[2] & 255) << 24) + ((bytes[3] & 255) << 16) + ((bytes[4] & 255) << 8)
					+ ((bytes[5] & 255) << 0) + 0x10000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 6 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_48BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC48BIT + ((long) (bytes[1] & 255) << 40) + ((long) (bytes[2] & 255) << 32) + ((long) (bytes[3] & 255) << 24) + ((bytes[4] & 255) << 16)
					+ ((bytes[5] & 255) << 8) + ((bytes[6] & 255) << 0) + 0x1000000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 7 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_56BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC56BIT + ((long) (bytes[1] & 255) << 48) + ((long) (bytes[2] & 255) << 40) + ((long) (bytes[3] & 255) << 32) + ((long) (bytes[4] & 255) << 24)
					+ ((bytes[5] & 255) << 16) + ((bytes[6] & 255) << 8) + ((bytes[7] & 255) << 0) + 0x100000000000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable data binary with length stored as 8 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	CRC384_64BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startCRC64BIT + ((long) bytes[1] << 56) + ((long) (bytes[2] & 255) << 48) + ((long) (bytes[3] & 255) << 40) + ((long) (bytes[4] & 255) << 32)
					+ ((long) (bytes[5] & 255) << 24) + ((bytes[6] & 255) << 16) + ((bytes[7] & 255) << 8) + ((bytes[8] & 255) << 0);
		}
	...
	GUID184 {
		...
		@Override
		public final boolean isGuidXXX() {
	...
	/** Binary Text byte array less than 48 bytes length. (length in first byte) */
	TEXT {
	...
	/** For all immutable character data with it's binary length stored as 1 byte, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	TXT384_8BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startTXT8BIT + (bytes[1] & 0xFF) + 0x100L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable character data with it's binary length stored as 2 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	TXT384_16BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startTXT16BIT + ((bytes[1] & 255) << 8) + ((bytes[2] & 255) << 0) + 0x10000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
	...
	/** For all immutable character data with it's binary length stored as 3 bytes, whirlpool-based.
	 *
	 * Format: guid-type byte, then 48 bytes of checksum. */
	TXT384_24BIT_SZ {
		...
		long getBinaryLength(final byte[] bytes) {
			...
			return GuidType.startTXT24BIT + ((bytes[1] & 255) << 16) + ((bytes[2] & 255) << 8) + ((bytes[3] & 255) << 0) + 0x1000000L * ((bytes[0] & 0xFF) - this.startIndex);
		}
		...
		@Override
		public final boolean isBinaryText() {
	...
	/** TODO: GUID_STREAM_INLINE
	 *
	 * TODO: GUID_STREAM_INLINE48 */
	GUID_RESERVED {
	...
	JS_MAP_EMPTY {
		...
		final BaseObject getBaseObject(final byte[] bytes) {
			...
			return BaseObject.SEALED_EMPTY_OBJECT;
		}
	...
	JS_ARRAY_EMPTY {
		...
		final BaseObject getBaseObject(final byte[] bytes) {
			...
			return BaseArray.SEALED_EMPTY_ARRAY;
		}
	...
	/** INVALID value - any invalid guid should take this guid type after been read from parameter,
	 * and should throw error if read from stream, just because stream will become corrupted since
	 * real guid length is unknown. */
	INVALID {
	...
	static final long startINP48BIT = GuidType.startINP40BIT + 0x10000000000L * NUMBER_POSITIVE_INT_40BIT.count();
	
	static final long startINP56BIT = GuidType.startINP48BIT + 0x1000000000000L * NUMBER_POSITIVE_INT_48BIT.count();
	
	static final long startINP64BIT = GuidType.startINP56BIT + 0x100000000000000L * NUMBER_POSITIVE_INT_56BIT.count();
	
	static final long startDATE40BIT = 1;
	
	static final long startDATE64BIT = GuidType.startDATE40BIT + 0x10000000000L * DATE_POSITIVE_INT_40BIT.count();
	...
	static final long startTXT8BIT = 48;
	
	static final long startTXT16BIT = GuidType.startTXT8BIT + 0x100L * TXT384_8BIT_SZ.count();
	
	static final long startTXT24BIT = GuidType.startTXT16BIT + 0x10000L * TXT384_16BIT_SZ.count();
	
	static final long startTXT64BIT = GuidType.startTXT24BIT + 0x1000000L * TXT384_24BIT_SZ.count();
	
	// java implementation (.values() method) is MUCH slower: allocates array,
	// copies, collects.
	static final GuidType[] ALL = GuidType.values();

	public static final byte[] createCRC(final byte[] binary, final long length) {
	...
	static final byte[] createCRC(final WhirlpoolDigest digest, final long length) {
		...
		}
		{
			...
			bytes[0] = (byte) GuidType.CRC384_64BIT_SZ.startIndex;
	...
	public static byte[] createDATE(final long date) {
		...
		if (date < GuidType.startDATE64BIT) {
			final long value = date - GuidType.startDATE40BIT;
		...
		{
			final long value = date - GuidType.startDATE64BIT;
			final byte[] bytes = new byte[GuidType.DATE_POSITIVE_INT_64BIT.getLeastSize(0) + 1];
			bytes[0] = (byte) GuidType.DATE_POSITIVE_INT_64BIT.startIndex;
			bytes[1] = (byte) (value >> 56);
			bytes[2] = (byte) (value >> 48);
			bytes[3] = (byte) (value >> 40);
			bytes[4] = (byte) (value >> 32);
	...
	public static final byte[] createTXT(final byte[] binary, final long length) {

		final WhirlpoolDigest digest = new WhirlpoolDigest();
		digest.update(binary);
		return GuidType.createTXT(digest, length);
	}

	public static final byte[] createTXT(final TransferCopier binary, final long length) {
	...
	static final byte[] createTXT(final WhirlpoolDigest digest, final long length) {

		final byte[] bytes = new byte[49];
		digest.guidSet48(bytes);
		if (length < GuidType.startTXT16BIT) {
			final long value = length - GuidType.startTXT8BIT;
			bytes[0] = (byte) (GuidType.TXT384_8BIT_SZ.startIndex + value / 0x100L);
			bytes[1] = (byte) value;
			return bytes;
		}
		if (length < GuidType.startTXT24BIT) {
			final long value = length - GuidType.startTXT16BIT;
			bytes[0] = (byte) (GuidType.TXT384_16BIT_SZ.startIndex + value / 0x10000L);
			bytes[1] = (byte) (value >> 8);
			bytes[2] = (byte) value;
			return bytes;
		}
		/** <code>
		if (length < GuidType.startTXT32BIT) {
			final long value = length - GuidType.startTXT24BIT;
			bytes[0] = (byte) (GuidType.TXT384_24BIT_SZ.startIndex + value / 0x1000000L);
			bytes[1] = (byte) (value >> 16);
			bytes[2] = (byte) (value >> 8);
			bytes[3] = (byte) value;
			return bytes;
		}
		if (length < GuidType.startTXT40BIT) {
			final long value = length - GuidType.startTXT32BIT;
			bytes[0] = (byte) (GuidType.TXT384_32BIT_SZ.startIndex + value / 0x100000000L);
			bytes[1] = (byte) (value >> 24);
			bytes[2] = (byte) (value >> 16);
			bytes[3] = (byte) (value >> 8);
			bytes[4] = (byte) value;
		...
		if (length < GuidType.startTXT48BIT) {
			final long value = length - GuidType.startTXT40BIT;
			bytes[0] = (byte) (GuidType.TXT384_40BIT_SZ.startIndex + value / 0x10000000000L);
			bytes[1] = (byte) (value >> 32);
			bytes[2] = (byte) (value >> 24);
			bytes[3] = (byte) (value >> 16);
			bytes[4] = (byte) (value >> 8);
		...
		if (length < GuidType.startTXT56BIT) {
			final long value = length - GuidType.startTXT48BIT;
			bytes[0] = (byte) (GuidType.TXT384_48BIT_SZ.startIndex + value / 0x1000000000000L);
			bytes[1] = (byte) (value >> 40);
			bytes[2] = (byte) (value >> 32);
			bytes[3] = (byte) (value >> 24);
			bytes[4] = (byte) (value >> 16);
		...
		if (length < GuidType.startTXT64BIT) {
			 final long value = length - GuidType.startTXT56BIT;
			 bytes[0] = (byte) (GuidType.TXT384_56BIT_SZ.startIndex + value /
			 0x100000000000000L);
			bytes[1] = (byte) (value >> 48);
			bytes[2] = (byte) (value >> 40);
			bytes[3] = (byte) (value >> 32);
		...
		{
			final long value = length - GuidType.startTXT64BIT;
			bytes[0] = (byte) GuidType.TXT384_24BIT_SZ.startIndex;
			// bytes[0] = (byte) GuidType.TXT384_64BIT_SZ.startIndex;
			bytes[1] = (byte) (value >> 56);
			bytes[2] = (byte) (value >> 48);
			bytes[3] = (byte) (value >> 40);
			bytes[4] = (byte) (value >> 32);
	...
	BaseObject getBaseObject(final byte[] bytes) {
		...
		if (this.isInline()) {
			throw new AbstractMethodError("Should be overridden! type=" + this + ", byte=" + (bytes[0] & 0xFF));
		}
	...
	/** TODO: add non-inline TXT384_XXBIT_SZ
	 *
	 * @return */
	@SuppressWarnings("static-method")
	boolean isBinaryText() {
