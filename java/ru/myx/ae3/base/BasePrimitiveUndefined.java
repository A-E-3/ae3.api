...
public final class BasePrimitiveUndefined extends BasePrimitiveAbstract<Object> {
	...
	static {
		assert AbstractSAPI.logDebug("BasePrimitiveUndefined: static init.");
	}
	...
	@Override
	public BaseProperty baseFindProperty(final BasePrimitive<?> name) {
	...
	@Override
	public BaseProperty baseFindProperty(final CharSequence name) {
	...
	public String baseToJavaString() {
		...
		return BaseString.STR_UNDEFINED.baseToJavaString();
	}
	...
	public final BasePrimitiveString baseToString() {
		...
		return BaseString.STR_UNDEFINED;
	}
	...
	public String stringValue() {
		...
		return BaseString.STR_UNDEFINED.stringValue();
	}

	@Override
	public String toString() {
		
		return BaseString.STR_UNDEFINED.toString();
	}

	@Override
	public ExecStateCode vmPropertyRead(final ExecProcess ctx, final BaseObject name, final BaseObject defaultValue, final ResultHandler store) {
		
		return ctx.vmRaise("cannot access property of undefined");
	}

	@Override
	public ExecStateCode vmPropertyRead(final ExecProcess ctx, final BasePrimitive<?> name, final BaseObject defaultValue, final ResultHandler store) {
