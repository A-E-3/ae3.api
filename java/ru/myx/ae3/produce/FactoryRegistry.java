...
/**
 * !!! remove this class - copy routines to 'Produce', just another level of
 * indirection
 * 
 * @author myx
 * 
...
final class FactoryRegistry {
	...
	final Object create(final Class<?> target, final String type, final BaseObject attributes, final Object context) {
		...
		return factory == null
				? null
				: factory.produce( type, attributes, context == null
						? null
	...
	ObjectFactory<?, ?> factory(
		...
		return factory == null
				? null
				: factory.factory( type, attributes, context );
	}
	 ...
	 * @param factory
	 */
	final synchronized void register(final ObjectFactory<?, ?> factory) {
	...
	final ObjectSource<?> source(
		...
		return factory == null
				? null
				: factory.prepare( type, attributes, context == null
						? null
						: context.getClass(), context );
	}
	...
	final ObjectTarget<?> target(
		...
		return factory == null
				? null
				: factory.connect( type, attributes, sourceClass, targetChain );
	}
