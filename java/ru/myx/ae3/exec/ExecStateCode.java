...
public enum ExecStateCode {
	...
	/** Return's true for valid exit state codes for function calls by context.vmCall method
	 *
	 * To use invalid return codes function should implement ExecFunctionUnsafe interface.
	 *
	 * @return */
