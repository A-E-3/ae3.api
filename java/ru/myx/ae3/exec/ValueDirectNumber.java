...
@ReflectionIgnore
final class ValueDirectNumber extends Number implements BaseNumber<Number>, ExecValueDirect<Number>, ExecValuePrimitive<Number> {
	...
	ValueDirectNumber(final double value) {
	...
	public final ExecValueDirect<?> setValue(final double number) {
	...
	public BaseObject toDetached(final ExecProcess ctx) {
		...
		if (ctx.rzDirectNumber == this) {
			ctx.rzDirectNumber = null;
		}
		return this;
	}
