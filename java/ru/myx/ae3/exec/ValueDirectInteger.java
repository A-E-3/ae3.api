...
@ReflectionIgnore
final class ValueDirectInteger extends Number implements BaseNumber<Number>, ExecValueDirect<Number>, ExecValuePrimitive<Number> {
	...
	ValueDirectInteger(final int value) {
	...
	public final ExecValueDirect<?> setValue(final int number) {
	...
	public BaseObject toDetached(final ExecProcess ctx) {
		...
		if (ctx.rzDirectInteger == this) {
			ctx.rzDirectInteger = null;
		}
		return this;
	}
