 ...
 * absorption made using Target or OutputStream and retrieval via Source
 ...
 * reading.
 * 
 * Idea is to collect in memory or disk dynamically generated data and to
...
public interface TransferCollector extends Closeable, TransferSource {
	...
	/**
	 * If collector is not closed yet close() method will be called
	 * automatically.
	 * 
