...
public abstract class AbstractReplyException extends ExecNonMaskedException implements UniversalReplyAnswer<AbstractReplyException> {
	...
	/** Returns the SAME response exception.
	 *
	 * @param name
	 * @param value
	 * @return same exception */
	@Override
	public final AbstractReplyException addAttribute(final String name, final BaseObject value) {
	 ...
	 * @return same exception */
	@Override
	public final AbstractReplyException addAttribute(final String name, final int value) {
	 ...
	 * @return same exception */
	@Override
	public final AbstractReplyException addAttribute(final String name, final long value) {
	 ...
	 * @return same exception */
	@Override
	public final AbstractReplyException addAttribute(final String name, final Object value) {
	 ...
	 * @return same exception */
	@Override
	public final AbstractReplyException addAttribute(final String name, final String value) {
	...
	public long getBinaryContentLength() {
		...
		return ((BodyAccessBinary) this.getReply()).getBinaryContentLength();
	}
	
	@Override
	public MessageDigest getBinaryMessageDigest() {

		return ((BodyAccessBinary) this.getReply()).getBinaryMessageDigest();
	}
