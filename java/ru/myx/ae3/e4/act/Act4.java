...
public class Act4 extends AbstractSAPI {
	...
	static {
		 ...
		 */
		{
			ACT_IMPL = AbstractSAPI.createObject(ACT_IMPL_CLASSNAME);
	 ...
	 * @return
	 */
	public static ActProcessContextBuilder createProcessBuilder(String string) {
	 ...
	 * @return
	 */
	public static ActProcessContext createProcess(String string) {
